...
def train_model(rank, world_size, args):
    ...
    train_loader, train_sampler = data.build_data_loader(vocab, "C:/Users/ys499/transformer_data/ratings_train.json", args, shuffle=True)
    test_loader, _ = data.build_data_loader(vocab, "C:/Users/ys499/transformer_data/ratings_test.json", args, shuffle=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", default="C:/Users/ys499/Desktop/DL_implement/Transformer/config.json", type=str, required=False,
                        help="config file")
    parser.add_argument("--vocab", default="C:/Users/ys499/transformer_data/web-crawler/kowiki/kowiki.model", type=str, required=False,
                        help="vocab file")

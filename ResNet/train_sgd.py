...
def main():
    ...
    writer = SummaryWriter(params.save_path + 'sgd/')
    ...
    for epoch in range(params.max_epoch):
        ...
        if (((epoch+1) % 10 )== 0 or (epoch == 0)):
            os.makedirs(params.save_path +'model_sgd/', exist_ok= True)
            torch.save(model.state_dict(), params.save_path +'model_sgd/'+ (str)(epoch+1)+'.pth')
